...
class SettingController extends Controller
{
    ...
    {
		$getsetting = DB::select("SELECT * FROM  settings"]);
        //$users = User::with('roles')->paginate(10);
        return view('settings.index', ['getsetting' => $getsetting]);
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            $user = User::create([
                ...
                'password'      => Hash::make($request->password),/*Hash::make($request->first_name.'@'.$request->mobile_number)*/
            ]);
